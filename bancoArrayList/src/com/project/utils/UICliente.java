...
public class UICliente {
	...
	public static void addCliente(List<Gestor> gestores, List<Cliente> clientes, Scanner sc) {
	...
	public static void getCliente(List<Cliente> clientes, Scanner sc) {
	...
	public static int comprobarIdCliente(List<Cliente> clientes, Scanner sc) {
		System.out.print("Proporciona la ID del cliente que quieres modificar: ");
		return Integer.parseInt(sc.nextLine())-1;
	}
	public static boolean existeCliente(List<Cliente> clientes, Scanner sc, int id, String menu) {
		try {
			clientes.get(id);
			return true;
		} catch (IndexOutOfBoundsException e) {
	...
	public static void updateNombreCliente(List<Cliente> clientes, Scanner sc, int id) {
		System.out.print("Inserte el nuevo nombre del cliente " + (id+1) + ": ");
		clientes.get(id).setNombre(sc.nextLine());
	}

	public static void updateApellidoCliente(List<Cliente> clientes, Scanner sc, int id) {
		System.out .print("Inserte el nuevo apellido del cliente " + (id+1) + ": ");
		clientes.get(id).setApellido(sc.nextLine());
	}

	public static void updateDniCliente(List<Cliente> clientes, Scanner sc, int id) {
		System.out.print("Inserte el DNI del cliente " + (id+1) + ": ");
		clientes.get(id).setDni(sc.nextLine());
	}

	public static void updateUsuarioCliente(List<Cliente> clientes, Scanner sc, int id) {
		System.out.print("Inserte el usuario del cliente " + (id+1) + ": ");
		clientes.get(id).setUsuario(sc.nextLine());
	}

	public static void updatePasswordCliente(List<Cliente> clientes, Scanner sc, int id) {
		System.out.print("Inserte la contraseña del cliente " + (id+1) + ": ");
		clientes.get(id).setPassword(sc.nextLine());
	}

	public static void updateCorreoCliente(List<Cliente> clientes, Scanner sc, int id) {
		System.out.print("Inserte el correo del cliente " + (id+1) + ": ");
		clientes.get(id).setCorreo(sc.nextLine());
	}
	
	public static void updateIdGestorCliente(List<Gestor> gestores, List<Cliente> clientes, Scanner sc, int id_cliente) {
	...
	public static void updateSaldoCliente(List<Cliente> clientes, Scanner sc, int id) {
	...
	public static void deleteCliente(List<Cliente> clientes, Scanner sc) {
