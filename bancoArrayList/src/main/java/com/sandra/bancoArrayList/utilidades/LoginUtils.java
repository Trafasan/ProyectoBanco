...
public class LoginUtils {
	 ...
	 */
	public static int guardarIdGestor(List<Gestor>gestores) {
	 ...
	 */
	public static boolean comprobacionIdGestor(List<Gestor> gestores, int idUsuario) {
		try {
			sc = new Scanner (System.in);
	...
	public static boolean coincidePasswordGestor(List<Gestor>gestores, int idUsuario) {
		sc = new Scanner (System.in);
	 ...
	 */
	public static int guardarIdCliente(List<Cliente>clientes) {
		sc = new Scanner (System.in);
		System.out.print("Introduzca su usuario: ");
		String usuario = sc.nextLine();
	 ...
	 * @return true si la ID es correcta o false si es errónea
	 */
	public static boolean comprobacionIdCliente(List<Cliente> clientes, int idUsuario) {
		try {
			sc = new Scanner (System.in);
	...
	public static boolean coincidePasswordCliente(List<Cliente>clientes, int idUsuario) {
		sc = new Scanner (System.in);
		System.out.print("Inserte su contraseña: ");
		String password = sc.nextLine();
