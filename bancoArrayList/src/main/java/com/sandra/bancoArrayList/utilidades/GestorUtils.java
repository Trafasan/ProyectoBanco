...
public class GestorUtils{
	...
	public static void addGestor(List<Gestor> gestores) {
	...
	public static void addGestores(List<Gestor> gestores) {
		sc = new Scanner (System.in);
	...
	public static void getGestor(List<Gestor> gestores) {
		sc = new Scanner (System.in);
	...
	public static int comprobarIdGestor(List<Gestor> gestores) {
		sc = new Scanner (System.in);
	...
	public static void updateNombreGestor(List<Gestor> gestores, int id) {
		sc = new Scanner (System.in);
		System.out.print("Inserte el nuevo nombre del gestor " + (id+1) + ": ");
		gestores.get(id).setNombre(sc.nextLine());
	}

	public static void updateApellidoGestor(List<Gestor> gestores, int id) {
		sc = new Scanner (System.in);
		System.out.print("Inserte el nuevo apellido del gestor " + (id+1) + ": ");
		gestores.get(id).setApellido(sc.nextLine());
	}

	public static void updateDniGestor(List<Gestor> gestores, int id) {
		sc = new Scanner (System.in);
		System.out.print("Inserte el DNI del gestor " + (id+1) + ": ");
		gestores.get(id).setDni(sc.nextLine());
	}

	public static void updateUsuarioGestor(List<Gestor> gestores, int id) {
		sc = new Scanner (System.in);
		System.out.print("Inserte el nuevo usuario del gestor " + (id+1) + ": ");
		gestores.get(id).setUsuario(sc.nextLine());
	}

	public static void updatePasswordGestor(List<Gestor> gestores, int id) {
		sc = new Scanner (System.in);
		System.out.print("Inserte la nueva contraseña del gestor " + (id+1) + ": ");
		gestores.get(id).setPassword(sc.nextLine());
	}

	public static void updateCorreoGestor(List<Gestor> gestores, int id) {
		sc = new Scanner (System.in);
	...
	public static void deleteGestor(List<Gestor> gestores) {
		sc = new Scanner (System.in);
